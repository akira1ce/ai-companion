...
export function ChatHeader({ emotion }: ChatHeaderProps) {
	return (
		<header className="absolute top-0 z-10 flex h-16 w-full items-center justify-between bg-white/60 px-4 py-2.5 shadow backdrop-blur-[20px] backdrop-saturate-180">
